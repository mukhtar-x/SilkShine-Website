...
const resources = {
    en: {
        translation: {
            ...
            formSubmitSuccess: 'Message sent successfully! We will respond shortly.',
            formSubmitError: 'Unable to send message. Please try again later.',
            subtotal: 'Subtotal',
            discount: 'Discount',
            total: 'Total',
    ...
    ur: {
        translation: {
            ...
            formSubmitSuccess: 'پیغام کامیابی سے بھیجا گیا! ہم جلدی جواب دیں گے۔',
            formSubmitError: 'پیغام بھیجنے میں ناکامی۔ براہ کرم دوبارہ کوشش کریں۔',
            subtotal: 'سب ٹوٹل',
            discount: 'رعایت',
            total: 'کل',
            couponCode: 'کوپن کوڈ',
...
// Handle Direction Change (SSR-safe)
