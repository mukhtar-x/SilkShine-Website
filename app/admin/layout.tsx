...
import { LayoutDashboard, ShoppingCart, Package, FileText, LogOut, Menu, X, Settings } from 'lucide-react';
        ...
        <div className="min-h-screen bg-navy-50 flex flex-col md:flex-row font-sans">
            ...
            `}>
                ...
                <div className="p-4 border-t border-navy-800">
                    <button onClick={handleLogout} className="flex items-center gap-3 px-4 py-3 w-full text-left rounded-lg text-navy-100 hover:bg-navy-800 hover:text-white transition-colors duration-200">
                        <LogOut className="w-5 h-5" />
                        <span>Logout</span>
                    </button>
                    <Link href="/" className="flex items-center gap-3 px-4 py-3 w-full text-left rounded-lg text-navy-400 hover:bg-navy-800 hover:text-white transition-colors duration-200 mt-2 text-sm">
