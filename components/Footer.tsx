            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                ...
                <div className="space-y-2">
                    ...
                    <ul className="space-y-2 text-xs text-gray-400">
                        <li><Link href="/products" className="hover:text-amber-400 transition-colors">{t('products')}</Link></li>
                        <li><Link href="/about" className="hover:text-amber-400 transition-colors">{t('story')}</Link></li>
                        <li><Link href="/#process" className="hover:text-amber-400 transition-colors">Process Breakdown</Link></li>
                    </ul>
                </div>
